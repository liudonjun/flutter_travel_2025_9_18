    ...
    return Obx(() => BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              icon: Image.asset(AssetsImages.chuxingPng,
            ...
            BottomNavigationBarItem(
              icon: Image.asset(AssetsImages.dingdanPng,
                  width: 48.w, height: 48.w),
            ...
            BottomNavigationBarItem(
              icon: Image.asset(AssetsImages.xiaoxiPng,
                  width: 48.w, height: 48.w),
              activeIcon: Image.asset(AssetsImages.xiaoxi1Png,
                  width: 48.w, height: 48.w),
              label: '消息',
            ),
            BottomNavigationBarItem(
              icon:
                  Image.asset(AssetsImages.wodePng, width: 48.w, height: 48.w),
              activeIcon:
